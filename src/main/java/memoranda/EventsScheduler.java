...
public class EventsScheduler {
    ...
    static {
        ...
        // < Class DefaultEventNotifier did too little, migrated the code here and put inside
        // a new IEventNotificationListener() object. >
        addListener(new IEventNotificationListener() {
